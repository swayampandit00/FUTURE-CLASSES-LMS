...
router.post("/upload", authenticateMiddleware, upload.single("file"), async (req, res) => {
  try {
...
router.post("/bulk-upload", authenticateMiddleware, upload.array("files", 10), async (req, res) => {
  try {
